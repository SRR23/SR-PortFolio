                ...
                >
                    ...
                    <div className="col-md-8 text text-center" style={{ zIndex: 2 }}>
                        ...
                        <div className="desc">
                            ...
                            >
                                I am a passionate **Django Developer** with over **1 years of experience** in web development, specializing in **Django, Django Rest Framework (DRF), React, and front-end technologies**. I enjoy building efficient, scalable, and user-friendly applications that solve real-world problems.
                            </p>

                            {/* Additional Details */}
                            <p className="animate" style={{ color: "#ddd" }}>
                                🎓 Currently pursuing a **B.Sc.(Engg.) in ICT** at **Islamic University, Bangladesh**. <br />
                                💡 Experienced in **API development, authentication, and full-stack development**. <br />
                            ...
                            <p>
                                ...
                                >
                                    Download Resume <span className="ion-ios-arrow-forward"></span>
                                </a>
                            </p>
                        </div>
                    </div>
